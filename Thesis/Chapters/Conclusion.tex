...
Výsledkem vyhledávání je struktura stavů, neboli historie procházení.
...
Mezi tato možná rozšíření patří hlavně doplnění dalších vzorů pro regulární výrazy z jazyka JavaScript.
Dalším možným rozšířením aplikace by mohlo být přidání podpory více standardů regulárních výrazů z jiných jazyků, jako je například PCRE.
Aplikace by mohla v případě nutnosti být potencionálně zrychlená optimalizací kódu, nebo přepsáním části kódu do nízkoúrovňového jazyka, jako je C++ nebo Rust.
